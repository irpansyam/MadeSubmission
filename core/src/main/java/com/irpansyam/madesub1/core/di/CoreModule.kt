package com.irpansyam.madesub1.core.di

import androidx.room.Room
import com.irpansyam.madesub1.core.data.MovieRepository
import com.irpansyam.madesub1.core.data.source.local.LocalDataSource
import com.irpansyam.madesub1.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("irpan".toCharArray())
